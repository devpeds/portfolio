const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ProjectDetailModal-zDGq4bR7.js","assets/index-Ce9eqAGM.js","assets/ProjectDetailModal-DelCCQy9.css","assets/client-D_2ahE53.js"])))=>i.map(i=>d[i]);
...
`,pa=Object.freeze(Object.defineProperty({__proto__:null,attributes:ia,html:ca},Symbol.toStringTag,{value:"Module"})),ua={name:"빌리피(Beliefy)",description:"인증 기반 데이팅 앱",startAt:"2023-10",endAt:"2024-11",techStack:["Dart","Flutter","BloC"]},fa=`<h1>빌리피(Beliefy)</h1>
...
`,da=Object.freeze(Object.defineProperty({__proto__:null,attributes:ua,html:fa},Symbol.toStringTag,{value:"Module"})),ha={name:"페즈폴리오(PEDSFOLIO)",description:"SPA 기반 개인 포트폴리오 사이트",startAt:"2024-12",techStack:["TypeScript","React","Emotion","Vite","SWC"]},ga=`<h1>페즈폴리오(PEDSFOLIO)</h1>
...
`,ma=Object.freeze(Object.defineProperty({__proto__:null,attributes:ha,html:ga},Symbol.toStringTag,{value:"Module"})),ya={name:"플레이윙즈 리뉴얼 프로젝트",description:"여행 특가 알림 서비스 플레이윙즈의 리뉴얼 프로젝트",startAt:"2020-02",endAt:"2022-03",techStack:["TypeScript","React Native","MobX","GraphQL"]},wa=`<h1>플레이윙즈 리뉴얼 프로젝트</h1>
...
`,ja=Object.freeze(Object.defineProperty({__proto__:null,attributes:ya,html:wa},Symbol.toStringTag,{value:"Module"})),ba={name:"플레이윙즈 웹 어플리케이션",description:"SEO를 통한 사용자 유입 증대와 웹투앱 마케팅을 진행하기 위한 웹 어플리케이션",startAt:"2021-01",endAt:"2023-06",techStack:["TypeScript","Gatsby","TanStack Query","Material UI","Emotion","GraphQL"]},va=`<h1>플레이윙즈 웹 어플리케이션</h1>
...
</details>`,Sa=Object.freeze(Object.defineProperty({__proto__:null,attributes:ba,html:va},Symbol.toStringTag,{value:"Module"})),Fa={name:"프루피(Proofy)",description:"소울바운드토큰(SBT) 기반 신원 인증 앱",startAt:"2023-07",endAt:"2024-06",techStack:["TypeScript","React Native","TanStack Query","Jotai","Tailwind"]},ka=`<h1>프루피(Proofy)</h1>
...
`,xa=Object.freeze(Object.defineProperty({__proto__:null,attributes:Fa,html:ka},Symbol.toStringTag,{value:"Module"}));function An(s){return new Date(parseInt(s.substring(0,4)),parseInt(s.substring(5))-1)}const _a={altong:pa,beliefy:da,proofy:xa,playwingsWeb:Sa,playwingsRenewal:ja,pedsfolio:ma},Ca=["pedsfolio","beliefy","altong","proofy","playwingsWeb","playwingsRenewal"].map(s=>{const{attributes:n,html:e}=_a[s],{startAt:t,endAt:a,...o}=n;return{...o,image:la[s],startAt:An(t),endAt:a?An(a):void 0,detail:e,showcase:sa[s]||[]}}),ts={name:"정승훈",aka:"페즈",contacts:{email:"hugh1127@gmail.com",github:"https://github.com/devpeds",linkedin:"https://www.linkedin.com/in/seunghoon-jung-041a811a5/"},skills:{Languages:[A.ts,A.dart],Frontend:[A.react,A.next,A.gatsby,A.rn,A.flutter],"Cloud Services":[A.firebase,A.aws],DevOps:[A.fastlane,A.gradle,A.gerrit]},careers:[{company:{name:"SBT"},positions:[{title:"소프트웨어 엔지니어",employmentType:"정규직",startAt:new Date(2023,6,1),endAt:new Date(2024,10,30),performances:["인증 기반 데이팅 서비스, 빌리피 모바일 어플리케이션 개발 및 운영","소울바운드 토큰(SBT)을 통한 신원 인증 서비스, 프루피 모바일 어플리케이션 개발 및 운영","알뜰폰 비교 서비스, 알통 웹 어플리케이션 개발"]}]},{company:{name:"스퀘어랩"},positions:[{title:"소프트웨어 엔지니어",employmentType:"정규직",startAt:new Date(2020,3),endAt:new Date(2023,5),performances:["플레이윙즈 모바일 어플리케이션 개발 및 운영","플레이윙즈 웹 어플리케이션 개발 및 운영","플레이윙즈 백오피스 시스템 개발 지원","3명의 프론트엔드 개발자로 구성된 팀의 개발 일정 조율 및 리소스 관리 (2023.01~2023.06)"]},{title:"소프트웨어 엔지니어",employmentType:"인턴",startAt:new Date(2020,0),endAt:new Date(2020,2),performances:["여행 특가 알림 서비스, 플레이윙즈 모바일 어플리케이션 개발","OTA 서비스, kTravel 프론트엔드 개발"]}]}],projects:Ca},$n=[{id:Fs.skills,name:"Skills",component:u(Ft,{skills:ts.skills})},{id:Fs.careers,name:"Careers",component:u(_t,{careers:ts.careers}),divider:!0},{id:Fs.projects,name:"Projects",component:u(Ot,{projects:ts.projects})}],Ea={footer:p({backgroundColor:h.dark})};function Ra(){return m.useEffect(()=>{const s=sessionStorage.getItem("scroll");s&&window.scrollTo(0,parseFloat(s))},[]),m.useEffect(()=>{const s=()=>{sessionStorage.setItem("scroll",window.scrollY.toString())};return window.addEventListener("beforeunload",s),()=>{window.removeEventListener("beforeunload",s)}},[]),z(en,{children:[u(St,{menus:$n}),u(Rt,{name:ts.name,aka:ts.aka}),u(xs,{children:$n.map(s=>z(m.Fragment,{children:[z(Us,{children:[u(Us.Title,{id:s.id,children:s.name}),s.component]}),s.divider&&u("hr",{})]},s.id))}),u("div",{css:Ea.footer,children:u(xs,{children:u(wt,{contacts:ts.contacts})})})]})}const Pa="/portfolio/assets/NanumSquareNeo-bRg-subset-CvTTexO4.woff",Ta="/portfolio/assets/NanumSquareNeo-bRg-subset-Czk0bR3U.woff2",Aa="/portfolio/assets/NanumSquareNeo-cBd-subset-D1tSDoIJ.woff",$a="/portfolio/assets/NanumSquareNeo-cBd-subset-CU4oSh0x.woff2",Ia=p("@font-face{font-family:'NanumSquare Neo';font-weight:400;font-display:swap;src:local('NanumSquare Neo'),url(",Ta,") format(woff2),url(",Pa,") format(woff);}@font-face{font-family:'NanumSquare Neo';font-weight:700;font-display:swap;src:local('NanumSquare Neo'),url(",$a,") format(woff2),url(",Aa,") format(woff);}*{margin:0;padding:0;box-sizing:border-box;line-height:1.5;text-underline-offset:0.3em;}:root{font-family:'NanumSquare Neo',system-ui,sans-serif;font-synthesis:none;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased;-moz-font-smoothing:grayscale;color:",h.dark87,";background-color:",h.lightGray,";}ul,ol{list-style:none;}button{background-color:transparent;border:0;color:inherit;font-family:inherit;font-size:inherit;font-weight:inherit;transition:color 0.2s,background-color 0.3s;}button:not(:disabled),[type='button']:not(:disabled){cursor:pointer;}hr{border-color:",h.dark12,";}");Js(async()=>{const{createRoot:s}=await import("./client-D_2ahE53.js").then(n=>n.c);return{createRoot:s}},__vite__mapDeps([3,1])).then(({createRoot:s})=>s(document.getElementById("root")).render(z(m.StrictMode,{children:[u(it,{styles:Ia}),u(Ra,{})]})));export{en as F,yt as I,m as a,z as b,h as c,p as d,ys as e,Pt as f,ie as g,Rs as h,tn as i,u as j,gt as k,dt as l,Ma as m,Oa as n,fe as r,rs as s,jt as u};

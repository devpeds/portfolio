...
`,ga=Object.freeze(Object.defineProperty({__proto__:null,attributes:fa,html:da},Symbol.toStringTag,{value:"Module"})),ha={name:"빌리피(Beliefy)",description:"인증 기반 데이팅 앱",startAt:"2023-10",endAt:"2024-11",techStack:["Dart","Flutter","BloC"]},ma=`<h1>빌리피(Beliefy)</h1>
...
`,ya=Object.freeze(Object.defineProperty({__proto__:null,attributes:ha,html:ma},Symbol.toStringTag,{value:"Module"})),wa={name:"페즈폴리오(PEDSFOLIO)",description:"SPA 기반 개인 포트폴리오 사이트",startAt:"2024-12",techStack:["TypeScript","React","Emotion","Vite","SWC"]},ja=`<h1>페즈폴리오(PEDSFOLIO)</h1>

...
function getHTML({ html }: typeof import('*.md')): string {
  return html
}
  ...
  projects: [
    {
      ...
      detail: import('./projects/beliefy.md').then(getHTML),
    },
    {
      name: '알통(Altong)',
      ...
      detail: import('./projects/altong.md').then(getHTML),
    },
    {
      name: '프루피(Proofy)',
      ...
      detail: import('./projects/proofy.md').then(getHTML),
    },
    {
      name: '플레이윙즈 웹 어플리케이션',
      ...
      detail: import('./projects/playwings-web.md').then(getHTML),
    },
    {
      name: '플레이윙즈 리뉴얼 프로젝트',
      ...
      detail: import('./projects/playwings-renewal.md').then(getHTML),
    },
  ],
}
